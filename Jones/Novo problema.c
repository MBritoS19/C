...
int main() 
{
	//Precisa declarar o entradas e o existe
  	...
  	printf("\nDigite a descricao do seu problema, termine a descricao com o caractere §:\n");
  	/*while((letra = getchar()) != '§')
  	{
  	...
  	system("gcc soma.c -o soma 2> a.txt");
  	system("soma");
  	...
  	for(i = 1;i <= entradas;i++)
  	{
    	...
    	printf("\nDigite a entrada de numero %d do seu problema, termine a descrição da entrada com Ctrl + c:\n", i);
