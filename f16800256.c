...
//
        ...
        printf("\nElementos segundo o nivel selecionado:(inicia pela raiz)\n");
    	MostraNivel(level, tree->root);
        
    	printf("\nMediana da Arvore:\n");
    	mediana(tree->amount,tree->root);
    	
        printf("\nPor favor escolha a opcao desejada:\n1-Inserir um novo valor na arvore atual.\n2-Excluir um elemento na arvore.\n3-Mostrar nos de acordo com o nivel.\n4-Sair\n");
        scanf("%d", &Exit);
        printf("\n");
        ...
        case 3:
        printf("Por gentileza cite qual nivel:");
        scanf("%d",&level);
        break;
